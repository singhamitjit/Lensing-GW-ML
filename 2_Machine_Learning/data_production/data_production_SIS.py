...
lensed_images = np.array([ imageio.imread('/home/amitjit/output/spectrograms/SIS/SIS_Lensed_' +str(i+1) + '.png').ravel() for i in range(n_samples)])
...
np.savez('/home/amitjit/output/data_SIS_1000', X_train = X_train, X_test = X_test, y_test = y_test, y_train = y_train, rank_test = rank_test)
