...
svc = joblib.load('/home/amitjit/output/SVC_1000.pkl')
...
plt.savefig('/home/amitjit/output/Final/SVC_cn_matrix_1000.pdf',bbox_tight=True)
plt.close()

cr_svc = open('/home/amitjit/output/Final/SVC_classification_report_1000.txt', 'w')
cr_svc.write("Classification report for classifier %s:\n%s\n\n" % (svc, metrics.classification_report(y_test, predicted_svc, digits = 3)))
cr_svc.close()

mc_svc = open('/home/amitjit/output/Final/SVC_misclassified_1000.txt', 'w')
...
rfc = joblib.load('/home/amitjit/output/RFC_1000.pkl')
...
cr_rfc = open('/home/amitjit/output/Final/RFC_classification_report_1000.txt', 'w')
cr_rfc.write("Classification report for classifier %s:\n%s\n\n" % (rfc, metrics.classification_report(y_test, predicted_rfc, digits = 3)))
cr_rfc.close()

mc_rfc = open('/home/amitjit/output/Final/RFC_misclassified_1000.txt', 'w')
...
plt.savefig('/home/amitjit/output/Final/MLP_cn_matrix_1000.pdf',bbox_tight = True)
plt.close()

cr_mlp = open('/home/amitjit/output/Final/MLP_classification_report_1000.txt', 'w')
cr_mlp.write("Classification report for classifier %s:\n%s\n\n" % (mlp, metrics.classification_report(y_test, predicted_mlp, digits = 3)))
cr_mlp.close()

mc_mlp = open('/home/amitjit/output/Final/MLP_misclassified_1000.txt', 'w')
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.savefig('/home/amitjit/output/Final/Log_ROC_curve_1000.pdf',bbox_tight=True)
plt.close()
