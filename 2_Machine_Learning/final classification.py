...
svc = joblib.load('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/SVC/SVC.pkl')
...
plt.savefig('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/SVC/SVC_cn_matrix',bbox_inches='tight',dpi=500)
plt.close()

cr_svc = open('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/SVC/SVC_classification_report.txt', 'w')
cr_svc.write("Classification report for classifier %s:\n%s\n\n" % (svc, metrics.classification_report(y_test, predicted_svc, digits = 3)))
cr_svc.close()

mc_svc = open('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/SVC/SVC_misclassified.txt', 'w')
...
rfc = joblib.load('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/RFC/RFC.pkl')
...
plt.savefig('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/RFC/RFC_cn_matrix',bbox_inches='tight',dpi=500)
plt.close()

cr_rfc = open('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/RFC/RFC_classification_report.txt', 'w')
cr_rfc.write("Classification report for classifier %s:\n%s\n\n" % (rfc, metrics.classification_report(y_test, predicted_rfc, digits = 3)))
cr_rfc.close()

mc_rfc = open('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/RFC/RFC_misclassified.txt', 'w')
...
mlp = joblib.load('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/MLP/MLP.pkl')
print('Performing RFC Classificiation')
...
plt.savefig('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/MLP/MLP_cn_matrix',bbox_inches='tight',dpi=500)
plt.close()

cr_mlp = open('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/MLP/MLP_classification_report.txt', 'w')
cr_mlp.write("Classification report for classifier %s:\n%s\n\n" % (mlp, metrics.classification_report(y_test, predicted_mlp, digits = 3)))
cr_mlp.close()

mc_mlp = open('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/MLP/MLP_misclassified.txt', 'w')
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.savefig('C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/Final/Log ROC curve.png', dpi=500)
plt.close()
