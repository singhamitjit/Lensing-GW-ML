...
def multi(spec_count):
    ...
    for i in range(spec_counter, spec_counter+1000):
        ...
        plt.ylim([0,400])
        plt.savefig("/home/amitjit/output/spectrograms/SIS/Lensed_" + str(spec_counter), bbox_inches=0, pad_inches= 0, transparent= True, dpi=50)
        plt.close()
        
        
        f = open("/home/amitjit/output/spectrograms/SIS/Lensed_" + str(spec_counter) + ".txt", "w")
