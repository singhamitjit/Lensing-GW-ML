# -*- coding: utf-8 -*-
"""
Created on Mon Aug 20 23:38:39 2018
...
for i in progress(range(spec_counter, 100)):
    G    = 6.674*10**-11
    c    = 2.998*10**8
    p    = 3.086*10**16
    ...
    plt.ylim([0,400])
    plt.savefig("C:\Users\Ivan\Desktop\Gravitational Lensing CUHK\Amit\SIS_Lensed2\SIS_Lensed_" + str(spec_counter), bbox_inches=0, pad_inches= 0, transparent= True, dpi=50)
    plt.close()
    
    
    f = open("C:\Users\Ivan\Desktop\Gravitational Lensing CUHK\Amit\SIS_Lensed2\SIS_Lensed_" + str(spec_counter) + ".txt", "w")
