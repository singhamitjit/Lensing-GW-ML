...
for i in progress(range(spec_counter,4000)):
    ...
    plt.ylim([0,400])
    plt.savefig("C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/sklearn/100-trial/Images/Lensed/Lensed_" + str(spec_counter), bbox_inches=0, pad_inches= 0, transparent= True, dpi=50)
    plt.close()
    
    
    f = open("C:/Users/Amitjit/OneDrive - The Chinese University of Hong Kong/2018 Internship/Python/python/sklearn/100-trial/Images/Lensed/Lensed_" + str(spec_counter) + ".txt", "w")
